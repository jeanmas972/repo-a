...
export const createGroup = async (req, res) => {
    ...
    if(!name) {
        ...
        return res.status(400).json({ error: true, message: 'Name must have 5 caracters long !'});  
    }
    ...
    if(!description) {
        ...
        return res.status(400).json({ error: true, message: 'Description must have 5 caracters long !'});  
    }
    ...
    try {
        ...
        return res.status(400).json({ error: true, message: 'Error when created the group !'});        
    }
};
...
export const createGroupMeetup = async (req, res) => {
    ...
    if(!title) {
        ...
        return res.status(400).json({ error: true, message: 'Title must have 5 caracters long !'});  
    }
    ...
    if(!groupId) {
        return res.status(400).json({ error: true, message: 'Group id must provided'});
    }
...
export const getGroupMeetups = async (req, res) => {
    ...
    try {
        ...
        return  res.status(400).json({ error: true, message: 'Cannot fecth meetup'});
    }
};